...
import com.example.library.network.errorhandler.ExceptionHandle;
import com.example.library.network.errorhandler.HttpErrorHandler;
import com.example.library.network.interceptor.RequestInterceptor;
import com.example.library.network.interceptor.ResponseInterceptor;
    ...
    private static void getBaseUrl(ApiType apiType) {
        switch (apiType) {
            case SEARCH:
                ...
                break;
            case WEATHER:
                mBaseUrl = "https://api.qweather.com";//和风天气API
                break;
            case BING:
